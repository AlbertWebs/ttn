 <header class="header-area style-4 ">
         <div class="header-wrap">
            <div class="header-logo">
               <a href="{{ url('/') }}"><img alt="image" class="img-fluid"  src="{{ media_url(setting('logo'), 'uploads/logo-ttn.png') }}"></a>
            </div>
            <div class="menu-wrap">
               <div class="main-menu">
                  <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                     <div class="mobile-logo-wrap">
                        <a href="{{ url('/') }}"><img alt="image" style="width:214px" src="{{ media_url(setting('logo'), 'uploads/logo-ttn.png') }}"></a>
                     </div>
                  </div>
                  <ul class="menu-list">
                     ...
                     <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                           ...
                           <li><a href="#{{ $service->anchor ?: 'services' }}">{{ $service->title }}</a></li>
                           @endforeach
                        </ul>
                     </li>
                     ...
                     <ul class="topbar-right">
                        ...
                        <li>
                           <a href="tel:{{ setting('phone_primary') }}">
                              ...
                              {{ setting('phone_primary') }}<br>
                              {{ setting('phone_secondary') }}
                           </a>
                        </li>
                     </ul>
                     <a href="#contact-me" class="primary-btn1 btn-hover">
                        {{ setting('cta_label', 'Get in Touch') }}
