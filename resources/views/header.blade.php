 <header class="header-area style-4 ">
         <div class="header-wrap">
            <div class="header-logo">
               <a href="#"><img alt="image" class="img-fluid"  src="{{asset('uploads/logo-ttn.png')}}"></a>
            </div>
            <div class="menu-wrap">
               <div class="main-menu">
                  <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                     <div class="mobile-logo-wrap">
                        <a href="#"><img alt="image" style="width:214px" src="{{asset('uploads/logo-ttn.png')}}"></a>
                     </div>
                  </div>
                  <ul class="menu-list">
                  ...
                  <div class="d-lg-none d-block">
                     <ul class="topbar-right">
                        <li>Available 24Hours</li>
                        <li>
                           <a href="mailto:info@trustedtouchnursing.co.ke">
                              ...
                              <span class="__cf_email__" data-cfemail="066f68606967766a697e6846616b676f6a2865696b">info@trustedtouchnursing.co.ke</span>
                           </a>
                        </li>
                        <li>
                           <a href="tel:+254726961550">
