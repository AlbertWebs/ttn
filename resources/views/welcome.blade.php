                    ...
                    <div class="container position-relative">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-md-60 mb-sm-30">
                                ...
                                <h2 class="section-caption mb-xs-10">Why Choose Us</h2>
                                <h3 class="section-title mb-30" style="color:#0376c2; font-weight:700"><span class="wow charsAnimIn" data-splitting="chars">Our Core Values</span></h3>

                                <div class="row">
                                    <div class="col-lg-10">
                                        <p class="section-descr mb-50 mb-sm-30 wow fadeInUp" data-wow-delay="0.4s" style="color:#ea854b; font-weight:700">
                                            We are dedicated to providing exceptional nursing care that prioritizes the well-being and comfort of every individual we serve.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-lg-3 d-flex align-items-stretch mb-sm-30">
                                <div class="alt-features-item border-left mt-0">
                                    ...
                                    <h4 class="alt-features-title">Trust</h4>
                                    <div class="alt-features-descr">
                                        Build confidence with clients through accountability and dedication
                                    </div>
                                </div>
                            </div>
                            <!-- End Feature Item -->
                            ...
                            <div class="col-md-4 col-lg-3 d-flex align-items-stretch mb-sm-30">
                                <div class="alt-features-item border-left mt-0">
                                    ...
                                    <h4 class="alt-features-title">Compassion</h4>
                                    <div class="alt-features-descr">
                                        Approach all clients with genuine care, easing families' concerns.
                                    </div>
                                </div>
                            </div>
                            <!-- End Feature Item -->
                            ...
                            <div class="col-md-4 col-lg-3 d-flex align-items-stretch mb-sm-30">
                                <div class="alt-features-item border-left mt-0">
                                    ...
                                    <h4 class="alt-features-title">Cultural Sensitivity</h4>
                                    <div class="alt-features-descr">
                                        Embrase diversity and honor various cultural beliefs.
                                    </div>
                                </div>
                            </div>
                            <!-- End Feature Item -->
                            ...
                            <div class="col-md-4 col-lg-3 d-flex align-items-stretch">
                                <div class="alt-features-item border-left mt-0">
                                    ...
                                    <h4 class="alt-features-title">Professionalism</h4>
                                    <div class="alt-features-descr">
                                        Maintain consistency, ethical standard and focus on quality care.
                                    </div>
                                </div>
                            </div>
                            <!-- End Feature Item -->
                            ...
                            <div class="col-md-4 col-lg-3 d-flex align-items-stretch">
                                <div class="alt-features-item border-left mt-0">
                                    ...
                                    <h4 class="alt-features-title">Confidentiality</h4>
                                    <div class="alt-features-descr">
                                        Protect the privacy and information of our clients
                                    </div>
                                </div>
                            </div>
                            <!-- End Feature Item -->
                            ...
                            <div class="col-md-4 col-lg-3 d-flex align-items-stretch">
                                <div class="alt-features-item border-left mt-0">
                                    ...
                                    <h4 class="alt-features-title">Empathy and Care</h4>
                                    <div class="alt-features-descr">
                                        Understand and support clients needs with warmth
                                    </div>
                                </div>
                            </div>
                            <!-- End Feature Item -->
                            ...
                            <div class="col-md-4 col-lg-3 d-flex align-items-stretch">
                                <div class="alt-features-item border-left mt-0">
                                    ...
                                    <h4 class="alt-features-title">Integrity</h4>
                                    <div class="alt-features-descr">
                                        Practice transparency and honesty in every service
                                    </div>
                                </div>
                            </div>
                            <!-- End Feature Item -->
                            ...
                            <div class="col-md-4 col-lg-3 d-flex align-items-stretch">
                                <div class="alt-features-item border-left mt-0">
                                    ...
                                    <h4 class="alt-features-title">Respect</h4>
                                    <div class="alt-features-descr">
                                        Treat everyone with Respect, honoring their individuality
                                    </div>
                                </div>
                            </div>
                            <!-- End Feature Item -->
